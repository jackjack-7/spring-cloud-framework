...
import com.infra.provider.model.domain.*;
import com.infra.user.model.domain.*;
import com.infra.user.model.dto.menu.UserMenuChildrenDto;
import com.infra.user.model.dto.menu.UserMenuDto;
import com.infra.provider.model.dto.user.*;
import com.infra.provider.service.*;
import com.infra.user.model.dto.user.*;
import com.infra.user.service.*;
...
import com.infra.user.mapper.UacActionMapper;
import com.infra.user.mapper.UacMenuMapper;
import com.infra.user.mapper.UacUserMapper;
import com.infra.user.mapper.UacUserMenuMapper;
import com.paascloud.provider.model.domain.*;
import com.paascloud.provider.model.dto.user.*;
import com.infra.user.model.enums.UacEmailTemplateEnum;
import com.infra.user.model.enums.UacUserSourceEnum;
import com.infra.user.model.enums.UacUserStatusEnum;
import com.infra.user.model.enums.UacUserTypeEnum;
import com.paascloud.provider.model.exceptions.UacBizException;
import com.paascloud.provider.model.vo.MenuVo;
import com.infra.user.model.vo.UserBindRoleVo;
import com.infra.user.mq.producer.EmailProducer;
import com.paascloud.provider.service.*;
import com.infra.user.utils.Md5Util;
